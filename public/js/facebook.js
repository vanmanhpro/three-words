...
function testAPI() {
  FB.api('/me', function (userInfo) {
    ...
    document.getElementById("profile-setting-avatar").src = `https://graph.facebook.com/${currentUser.id}/picture?width=15`;
    document.getElementById("username").textContent = `Hi, ${currentUser.name}`;
    document.getElementById("profile-setting-avatar").style.display = "";
...
function turnOffLoginBox() {
  ...
  document.getElementById("profile-setting-wrapper").style.display = "inline-flex";
...
function turnOffLogOutBox(){
  ...
  document.getElementById("profile-setting-wrapper").style.display = "none";
